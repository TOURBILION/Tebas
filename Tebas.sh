...
echo $yellow
figlet -f future "Babel Cyber Army"
echo
echo $red"##########################$green" WELCOME "$red###########################"
echo
...
echo $indigo"=============================================================="
echo
echo $white "╭─"$yellow"@Mr.APEL"$cyan" ~/BabelCyber"$white
read -p " ╰─$ "  apaan
echo
if [ $apaan = "A" ] || [ $apaan = "a" ]
then
...
echo $green "╭─"$blue"@Mr.APEL"$cyan" ~/BabelCyber"$white
read -p " ╰─$ "  target
echo
echo $red "Masukan Script!!! "
echo $green "╭─"$blue"@Mr.APEL"$cyan" ~/Nama SC Harus(index.html)"$white
read -p " ╰─$ "  script
...
echo
echo "Masukan Script !!!!"
echo $white "╭─"$green"@Mr.APEL"$cyan" ~/BabelCyber"$white                               
read -p " ╰─$ " script
echo
echo
echo $white"Masukan Target1 !!!!"
echo $white "╭─"$green"@Mr.APEL"$cyan" ~/Crot"$white
read -p " ╰─$ " target1
...
echo $red"##########################$green" WELCOME "$red###########################"
echo $green"Author  : Mr.APEL			"
echo $purple"Gthub   : https://github.com/TOURBILION"
echo $white"Blog    : Belum Ada"
echo
echo $yellow"                          THANKS TO :"
echo
echo $cyan"[+] Mr.Cyber01 & Mr.Kevin "
echo $cyan"[+] Mr.Zacki "
echo $cyan"[+] Mr.Azmi & All Member [B.C.A] "
echo $red"##########################$green" WELCOME "$red###########################"
